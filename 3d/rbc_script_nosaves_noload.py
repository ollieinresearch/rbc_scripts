...
logging.getLogger('dedalus.core.evaluator').setLevel(logging.DEBUG)
logging.getLogger('dedalus.tools.parallel').setLevel(logging.DEBUG)
...
# logger.debug(f"State tasks added.")
...
#     logger.debug(f"Snapshots tasks added.")
...
# an = solver.evaluator.add_file_handler(basepath / 'analysis', sim_dt=analysis_time, max_writes=None, mode=fh_mode, parallel=par)
...
# logger.debug(f"Analysis tasks added.")
...
logger.debug(f"Horizontal analysis tasks added.")
