...
state_time = 852 #save every 855 seconds (50 saves in 11hr 50 min)
...
analysis_time = 1/200 # 100 analysis file saves per unit of sim time - might want to increase for smaller timestep cases)
